...
private:
    ...
    Eigen::Vector3f Phong(const Eigen::Vector3d &point, const Eigen::Vector3d &normal, const Material &material, const std::vector<Light> &lights, const Eigen::Vector3d &cam) const;
public:
    Scene() = default;
