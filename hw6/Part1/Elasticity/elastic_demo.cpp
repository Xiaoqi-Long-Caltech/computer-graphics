...
{ 
    ...
    for(int i = 0; i < vertices.size(); i++)
    {
         ...
         */
         vertices[i].vx = (vertices[i].vx * vertices[i].mass + vertices[i].fx * tstep) / vertices[i].mass; // the numerator is the updated momentum
         vertices[i].vy = (vertices[i].vy * vertices[i].mass + vertices[i].fy * tstep) / vertices[i].mass;
